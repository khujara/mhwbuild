...
rem set KHLIB="D:\Dropbox\work\khlib"
...
set LinkerOptions= -incremental:no -opt:ref user32.lib gdi32.lib winmm.lib opengl32.lib Comdlg32.lib -DEBUG 
set INC=-I%KHLIB%

IF NOT EXIST .\..\build\ mkdir .\..\build
cd .\..\build

cl -DWIN32 %CompilerOptions% %INC% -D_CRT_SECURE_NO_WARNINGS /Femhwbuild.exe ..\src\main.cpp /link %LinkerOptions%
